...
public class LoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestContext.registerListener(new AuthorizeListener() {
            ...
            public void onSuccess(AuthorizeResult authorizeResult) {
                Log.i("Amazon Access Token" , authorizeResult.getAccessToken());
                accestoken = authorizeResult.getAccessToken();
    ...
    private void updateProfileData(String name, String email, String account, String zipCode) {
        ...
        profileBuilder.append(String.format("Access Token is %s\n", accestoken));
